...
- [ ] 11. Create distribution package
  - [ ] 11.1 Create release directory
    - Create oicp-power-release/ directory
    - Copy all power files to release directory
    - Verify directory structure is correct
    - _Requirements: 8.5_

  - [ ] 11.2 Create distribution archive
    - Create zip or tar.gz archive
    - Name archive with version number (e.g., oicp-power-1.0.0.tar.gz)
    - Verify archive contains all necessary files
    - _Requirements: 8.5_

  - [ ] 11.3 Write distribution documentation
    - Create INSTALL.md with installation steps
    - Document how to extract and install archive
    - Provide verification steps
    - _Requirements: 8.5_

- [ ] 12. Manual testing
  - [ ] 12.1 Test power installation
    - Install power in Kiro instance
    - Verify power appears in Powers panel
    - Check metadata displays correctly
    - _Requirements: 1.1, 1.2, 1.3_

  - [ ] 12.2 Test power activation
    - Activate power through Kiro
    - Verify POWER.md loads correctly
    - Check tools appear in toolsByServer
    - _Requirements: 1.4, 3.1_

  - [ ] 12.3 Test keyword activation
    - Send messages with "oicp" keyword
    - Send messages with "ev charging" keywords
    - Send messages with "hubject" keyword
    - Verify power is suggested for activation
    - _Requirements: 7.1, 7.2, 7.3_

  - [ ] 12.4 Test tool invocations
    - Test search_oicp_operations tool
    - Test get_operation_details tool
    - Test get_data_schema tool
    - Test list_services tool
    - Test search_schemas tool
    - Test get_operations_by_tag tool
    - _Requirements: 3.1, 3.2_

  - [ ] 12.5 Test steering files
    - Access getting-started.md through Kiro
    - Access cpo-workflows.md through Kiro
    - Access emp-workflows.md through Kiro
    - Verify content renders correctly
    - _Requirements: 5.1, 5.2, 5.3_

- [ ] 13. Final checkpoint - Verify all functionality
  - Ensure all tests pass, ask the user if questions arise.
